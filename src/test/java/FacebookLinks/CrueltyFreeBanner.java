...
public class CrueltyFreeBanner {
    ...
    public void studyLinks(String input1) throws Exception {
        ...
        WebElement cruelty_free = driver.findElement(By.xpath("//img[@class='logos-b'][@src='/offers/mobile/images/nov-woman/bottom-logos-1.png']"));
        cruelty_free.click();
